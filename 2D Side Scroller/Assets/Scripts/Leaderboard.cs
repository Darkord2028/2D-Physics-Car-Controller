...
{
    const string privateCode = "yF31AzTRlUO8AN-WO2icEAe7f0T9cBH0KHCd9bhdRRsg";
    const string publicCode = "693d1e288f40bb10047eec87";
    const string webURL = "https://hillracing-leaderboard.abhijdicaprio.workers.dev/dreamlo/";
